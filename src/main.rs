...
fn process_batch(
    ...
    let template = Arc::new(load_template(template_name)?);
    ...
    let final_logo = Arc::new(final_logo);
    ...
    rayon::ThreadPoolBuilder::new()
        ...
        .install(|| {
            ...
            for (image_path, result) in results {
                match result {
                    ...
                    Err(e) => {
                        ...
                        batch_result.errors.push((image_path.clone(), error_msg.clone()));
            ...
            println!("⏱  Time elapsed:  {:.2}s", batch_result.elapsed.as_secs_f64());
